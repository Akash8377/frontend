...
const SideContent = () => {
  return (
    ...
    >
      <div style={{ width: '100%' }}>
        <img src={logo} alt="Logo" style={{ margin: '-200px 70px 0px', display: 'block' }} />
        <div className="space40"></div>
        <Title level={3}>Welcome to Flyweis Admin Panel</Title>
        <div className="space20"></div>
        <ul className="list-checked">
          <li className="list-checked-item">
            <Space direction="vertical">
              <Text strong>All-in-one Panel</Text>

              <Text>Check for all data</Text>
            </Space>
          </li>
